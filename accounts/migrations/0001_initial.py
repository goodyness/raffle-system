    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('organizer', 'Raffle Organizer'), ('participant', 'Participant')], db_index=True, default='participant', max_length=20)),
